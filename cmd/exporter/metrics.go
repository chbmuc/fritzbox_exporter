...
var metrics = []*Metric{
	...
	},
	{
		...
		Desc: prometheus.NewDesc(
			"fritzbox_wan_connection_upstream_max_bitrate",
			"connection upstream max bitrate",
			nil,
			nil,
		),
		MetricType: prometheus.GaugeValue,
	},
	{
		...
		Desc: prometheus.NewDesc(
			"fritzbox_wan_connection_downstream_max_bitrate",
			"connection downstream max bitrate",
			nil,
			nil,
		),
		MetricType: prometheus.GaugeValue,
	},
	{
		...
		Desc: prometheus.NewDesc(
			"fritzbox_wan_connection_upstream_curr_bitrate",
			"connection upstream curr bitrate",
			nil,
			nil,
		),
		MetricType: prometheus.GaugeValue,
	},
	{
		...
		Desc: prometheus.NewDesc(
			"fritzbox_wan_connection_downstream_curr_bitrate",
			"connection downstream curr bitrate",
			nil,
			nil,
		),
		MetricType: prometheus.GaugeValue,
